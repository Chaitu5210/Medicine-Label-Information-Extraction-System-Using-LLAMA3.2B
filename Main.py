...
import gdown
import pandas as pd
from Database_Information_Retrival import retrieve_names
...
if __name__=='__main__':
    ...
    text = text + "               < Please identify only the main medicine name from this text nothing else. >"
    ...
    medicine_information = retrieve_names(medicine_name.strip())
